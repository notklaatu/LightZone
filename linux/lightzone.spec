...
BuildRequires:	ant, gcc, gcc-c++, make, tidy, git, javahelp2, libjpeg8-devel, liblcms2-devel, libtiff-devel, libX11-devel
...
Requires:	java >= 1.6.0, libjpeg-turbo, liblcms2-2, libtiff
